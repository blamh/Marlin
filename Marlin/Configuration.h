...
#define STRING_SPLASH_LINE1 "Marlin" // will be shown during bootup in line 1
...
#define MACHINE_UUID "7c7bbe1c-2965-47c6-a5cb-665c4688d6e3"
...
#define PID_K1 0.95      // Smoothing factor within the PID
  ...
  #define  DEFAULT_Kp 73.19
  #define  DEFAULT_Ki 11.75
  #define  DEFAULT_Kd 113.99
...
// http://www.instructables.com/id/Installing-and-Configuring-DRV8825-Stepper-Drivers/step3/Modifying-the-firmware-and-final-words/
...
#define IDLER_TEETH_Y 18 // 18 teeth

// http://3dnielsen.dk/product.php?id_product=1009
...
#define AXIS_STEPS_PER_UNIT_X (STEPS_PER_REVOLUTION_X / IDLER_TEETH_X / BELT_PITCH_X) // 3200/18/2 = 88.89
#define AXIS_STEPS_PER_UNIT_Y (STEPS_PER_REVOLUTION_Y / IDLER_TEETH_Y / BELT_PITCH_Y) // 3200/18/2 = 88.89
#define AXIS_STEPS_PER_UNIT_Z (STEPS_PER_REVOLUTION_Z / PITCH_OF_Z_ROD) * (100.0/99.7) // (3200/8)*1.0030 = 401.2036
#define AXIS_STEPS_PER_UNIT_E (STEPS_PER_REVOLUTION_E * EXTRUDER_GEAR_RATIO / (PINCH_WHEEL_DIAMETER * PI)) * (100.0/167.0) * (100/99.15) // 87.88
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      {2000,2000,60,1000}
